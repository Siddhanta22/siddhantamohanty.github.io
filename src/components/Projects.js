  ...
  const projects = [
    {
      ...
      summary: "An AI-driven reliability platform that turns raw production errors into actionable root-cause insights and fixes. Built an end-to-end Flask pipeline with PostgreSQL logging, FAISS retrieval, and LangChain + GPT fix generation, with severity-aware Slack triage.",
    ...
    },
    {
      ...
      title: "yourAIbrief",
      role: "Personal Project",
      summary: "A full-stack AI newsletter platform for curated, personalized daily intelligence. Automated ingestion, rule-based curation, and scheduled delivery via Next.js API routes, Prisma + PostgreSQL, NextAuth, and SendGrid.",
      technologies: ["Next.js", "TypeScript", "Prisma", "PostgreSQL", "NextAuth", "SendGrid"],
      impact: "Automates the full content pipeline from source ingestion to inbox delivery.",
    ...
    },
    {
      ...
      title: "Swipeflix",
      role: "Personal Project",
      summary: "A swipe-first movie discovery app with on-the-fly personalization. Built a React, Node.js, and MongoDB platform with a TensorFlow.js feedback loop that continuously learns from user swipe behavior.",
