...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      solution: "As part of the Generative AI internship, built MCP-powered workflows for LLM automation. Designed agentic RAG pipelines, vector database retrieval flows, and structured context-routing mechanisms that enabled internal teams to debug faster and build LLM-integrated tools more reliably. This directly reflects the MCP + RAG contributions that improved developer efficiency through intelligent context-aware execution.",
    ...
    },
    {
      ...
      solution: "A retrieval-augmented assistant trained on DSLR manuals, allowing users to ask natural-language questions about aperture, shutter speed, ISO, and more. Photobot extracts relevant documentation and generates simple, actionable photography instructions. This project matches the resume description but elaborates on function and use-case, providing context-aware recommendations for various photography scenarios.",
    ...
    },
    {
      ...
      solution: "A browser extension and backend workflow that tracks prompt versions, model responses, and evaluation metrics. Helps developers understand how prompt changes affect LLM outputs. This aligns with the resume's PromptTracer project but provides more depth on observability and analytics capabilities.",
    ...
    },
    {
      ...
      solution: "An academic planning tool that uses NLP to analyze course descriptions and build conflict-free graduation paths. Contributed to the frontend and pitched the project during HackPSU. This matches the resume exactly, expanded for storytelling and clarity on the NLP-powered conflict detection and planning features.",
