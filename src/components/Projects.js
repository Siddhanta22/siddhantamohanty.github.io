  ...
  const projects = [
    {
      ...
      problem: "An AI-powered error intelligence system that turns raw application and database failures into actionable triage for engineers.",
      solution: "Flask + PostgreSQL backend with structured log capture, FAISS-based similarity search, and LLM reasoning for root-cause analysis — delivered directly to engineers through a real-time Slack bot.",
      technologies: ["Python", "Flask", "PostgreSQL", "FAISS", "LangChain", "Slack API"],
      impact: "Reduced investigation time by ~40% and support resolution time by ~50% by clustering incidents and delivering high-signal explanations directly in Slack.",
    ...
    },
    {
      ...
      role: "Personal Project",
      problem: "A real-time collision detection engine with an interactive Canvas visualizer for large swarms of moving bodies.",
      solution: "Broad-phase collision using spatial hashing and AABB culling, with a modular strategy interface for plug-and-play algorithms and a benchmarking harness featuring HUD metrics, starfield rendering, and collision highlighting.",
      technologies: ["TypeScript", "Canvas API", "Spatial Hashing", "AABB Culling", "Physics Engine"],
      impact: "Reduced candidate checks by ~98% vs brute force and sustained 50–60× throughput gains on 1000 moving objects while preserving correctness.",
    ...
    },
    {
      ...
      role: "GenAI Intern",
      problem: "A retrieval-augmented assistant over DSLR manuals that answers camera settings questions with grounded, actionable responses.",
      solution: "PDF ingestion to chunking and embeddings, FAISS-based retrieval, and prompt-templated response generation tuned for concise, actionable guidance (aperture, shutter, ISO).",
      technologies: ["Python", "LangChain", "FAISS", "RAG"],
      impact: "Reduced lookup time by ~60% by converting long-form documentation into low-latency semantic search and summarized instructions.",
      github: null,
      live: null,
      icon: Camera,
    ...
    },
    {
      ...
      role: "Personal Project",
      problem: "A prompt observability tool that versions prompts and captures model outputs and evaluation signals for every run.",
      solution: "Chrome extension logs executions, a React UI visualizes prompt diffs and run timelines, and a backend workflow stores metadata for side-by-side comparisons across prompt variants and models.",
      technologies: ["JavaScript", "React", "Chrome Extension APIs"],
      impact: "Made prompt iteration repeatable with full traceability across changes, reducing regression risk when shipping model-backed features.",
    ...
    },
    {
      ...
      role: "Personal Project",
      problem: "A swipe-first movie discovery app with real-time preference modeling and fast filtering.",
      solution: "React and Tailwind UI with gesture-driven flows, a quiz-based cold start, a TensorFlow.js learning loop from swipe feedback, and an API-backed catalog with language, age, and genre filters.",
      technologies: ["React", "Tailwind CSS", "JavaScript", "TensorFlow.js", "Movie API", "UI/UX"],
      impact: "Increased session engagement by tightening the feedback loop and improving recommendation quality through swipe feedback.",
